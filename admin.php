  ...
  <body>
      ...
      <nav id="main-nav" class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
              <li><a id="link1" href="index.php">Student</a></li>
              <li class="active"><a id="link2" href="#">Admin</a></li>
            </ul>
        </div>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="adminlogin.php" method="POST">
        ...
        <input type="text" id="matricnum" class="form-control" name="username" placeholder="Username" value="admin" required autofocus>
